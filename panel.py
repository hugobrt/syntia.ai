...
class BotControlView(discord.ui.View):
    ...
    # BOUTON RETOUR : UTILISE LE LISTENER
...
class ChanSel(discord.ui.View):
    ...
    async def s(self, i: discord.Interaction, s: discord.ui.ChannelSelect):
        ...
        # PAS DE TICKET ICI
            ...
            await i.edit_original_response(content=f"✅ **Terminé !** Salon recréé.", view=None)
        elif self.a=="lock":
            await i.response.defer(ephemeral=True)
...
class MainPanelView(discord.ui.View):
    ...
    # BOUTON GESTION BOT : UTILISE LE LISTENER
...
class AdminPanel(commands.Cog):
    ...
    async def on_ready(self):
        ...
        print("🛡️ Panel V39 (NO TICKET + FIXED NAV) Ready.")
