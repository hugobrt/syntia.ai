...
# ====================================================
# 4. DASHBOARD & NAVIGATION (AJOUT BOT CONTROL)
# ====================================================

# --- AJOUT: MENU GESTION BOT ---
class BotControlView(discord.ui.View):
    ...
    async def back(self, i, b): pass # Géré par le listener global
...
class AdminPanelView(discord.ui.View):
    ...
    async def b03(self, i, b): pass # Géré par le listener global
...
class AdminPanel(commands.Cog):
    ...
    async def on_ready(self):
        ...
        self.bot.add_view(BotControlView()) # <-- AJOUT ICI
        self.bot.add_view(TicketControlView())
        self.bot.add_view(RequestAccessView())
        print("🛡️ Panel V27 (BASE V21 + NAVIGATION) Ready.")
    ...
    async def on_interaction(self, i: discord.Interaction):
        ...
        if cid == "nav:bot":
            ...
            await i.response.edit_message(content=None, embed=discord.Embed(title="🛡️ PANEL V27", color=0x2b2d31), view=AdminPanelView())
            return
        ...
        if cid.startswith("req:yes:"):
            ...
            await i.response.defer(ephemeral=True) # <-- FIX TICKET V21
